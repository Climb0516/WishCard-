...
{
    UIAlertController *aleartView =[UIAlertController alertControllerWithTitle:@"温馨提示" message:message   preferredStyle:UIAlertControllerStyleAlert];
...
//   mei查到数据
-(void)requestNOData:(NSString *)str{
    [SVProgressHUD dismiss];
    UIImageView *showImageView =[[UIImageView alloc]init];
    showImageView.image=[UIImage imageNamed:@"暂无数据_03"];
    [self.view addSubview:showImageView];
    UILabel *showLabel =[MyControl createLabelWithtext:str font:17 textcolor:RGBCOLOR(102, 102, 102) backgroundColor:nil];
    ...
    [showLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(self.view);
        make.top.equalTo(showImageView.mas_bottom).with.offset(15);
    }];
}
